  ...
  function crawl($url = '')
  {
    ...
    try
    {
      ...
      foreach ($hrefs as $key => $value)
      {
        ...
        if ((strpos($link, 'wix.com') === false) && (strpos($link,'motorbikinginfrance') === false) && (strpos($link,'villalemas') === false) && (strpos($link,'closdesseguineries') === false) && (strpos($link, 'smugmug') === false) && (strpos($link, 'javascript') === false) && (strpos($link, 'jpg') === false) && (strpos($link, 'mailto:') === false) && (!in_array($link, $this->links) && ($this->domain == $domain)))
        {
          $this->links[] = $link;
          $this->crawl($link);
        }
