 ...
 * @since       3.0
 */
abstract class JHtmlFcsortablelist
{
	/**
	 ...
	 * @since   3.0
	 */
	public static function fcsortable($tableId, $formId, $sortDir = 'asc', $saveOrderingUrl, $proceedSaveOrderButton = true, $nestedList = false)
	{
		// Only load once
		...
		JHtml::_('script', 'fc/sortablelist.js', false, true);
