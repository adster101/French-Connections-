 ...
 * @since       3.0
 */
class JToolbarButtonFcStandard extends JToolbarButton
{
	/**
	 * Button type
	 *
	 ...
	 * @since   3.0
	 */
	public function fetchButton($type = 'FcStandard', $name = '', $text = '', $task = '', $btnClass = 'btn btn-small', $list = true)
	{
