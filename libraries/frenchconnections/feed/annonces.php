 ...
 * @since       12.3
 */
class JFeedParserAnnonces extends JFeedParser {

    /**
     * @var    string  The feed element name for the entry elements.
     * @since  12.3
     */
    protected $entryElementName = 'annonces';
    ...
    protected function initialise() {
        ...
        $this->moveToNextElement('annonce');
    }
    ...
    protected function processElement(stdClass $feed, SimpleXMLElement $el) {
        ...
        $listing->bedrooms = (int) $el->nombre_chambre;
        $listing->bathrooms = (int) $el->nombre_salle_de_bain;
