<?php
/**
 * @version: $Id: view.php 2328 2012-03-27 17:58:07Z Radek Suski $
 ...
 * ===================================================
 * $Date: 2012-03-27 19:58:07 +0200 (Tue, 27 Mar 2012) $
 * $Revision: 2328 $
 * $Author: Radek Suski $
...
abstract class SPFrontView extends SPObject implements SPView
{
    ...
    protected function alphaMenu( &$data )
    {
        if ( $this->key( 'alphamenu.show', Sobi::Cfg( 'alphamenu.show' ) ) ) {
            ...
            static $isWin = null;
            if ( $isWin === null ) {
                $isWin = strstr( strtolower( php_uname( 's' ) ), 'windows' );
            }
                ...
                foreach ( $letters as $letter ) {
                    ...
                    if ( $isWin ) {
                        if( function_exists( 'mb_strtolower' ) ) {
                            $urlLetter = trim( mb_strtolower( $letter ) );
                        }
                        else {
                            $urlLetter = trim( $letter );
                        }
                    }
                    else {
                        $urlLetter =  trim( strtolower( $letter ) );
                    }
