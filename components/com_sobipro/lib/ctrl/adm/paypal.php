<?php
/**
 * @version: $Id: paypal.php 808 2011-02-18 23:08:58Z Radek Suski $
 ...
 * ===================================================
 * $Date: 2011-02-19 00:08:58 +0100 (Sat, 19 Feb 2011) $
 * $Revision: 808 $
 * $Author: Radek Suski $
...
class SPPaymentPP extends SPConfigAdmCtrl
{
	...
	private function screen()
	{
		...
		$ppexpl = SPLang::getValue( 'ppexpl', 'application' );
		$ppsubj = SPLang::getValue( 'ppsubject', 'application' );
		$view = $this->getView( 'paypal' );
		$tile = Sobi::Txt( 'APP.PPP_NAME' );
		$view->assign( Sobi::Reg( 'paypal.ppurl.value' ), 'ppurl' );
		$view->assign( Sobi::Reg( 'paypal.ppemail.value' ), 'ppemail' );
		$view->assign( Sobi::Reg( 'paypal.pprurl.value' ), 'pprurl' );
		$view->assign( Sobi::Reg( 'paypal.ppcc.value' ), 'ppcc' );
