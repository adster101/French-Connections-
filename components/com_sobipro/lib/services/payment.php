<?php
/**
 * @version: $Id: payment.php 1331 2011-05-12 13:29:18Z Radek Suski $
 ...
 * ===================================================
 * $Date: 2011-05-12 15:29:18 +0200 (Thu, 12 May 2011) $
 * $Revision: 1331 $
 * $Author: Radek Suski $
...
//		$this->discounts[ $id ][ 'for' ] = 'discount for new customer';
		...
		$r = array( 'positions' => $pos, 'discount' => $dis , 'summary' => $sum );
