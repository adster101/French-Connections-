<?php
/**
 * @version: $Id: alpha.php 2333 2012-03-28 09:30:17Z Radek Suski $
 ...
 * ===================================================
 * $Date: 2012-03-28 11:30:17 +0200 (Wed, 28 Mar 2012) $
 * $Revision: 2333 $
 * $Author: Radek Suski $
...
class SPAlphaListing extends SPSectionCtrl implements SPListing
{
    ...
    public function getEntries( $eLimit, $site, $ids = false )
    {
         ...
         */
        if( strstr( strtolower( php_uname( 's' ) ), 'windows' ) && function_exists( 'mb_strtolower' ) ) {
            // if windows and we have multibyte string support - ask both cases ...
            $baseCondition = "REGEXP:^{$this->_letter}|".mb_strtoupper( $this->_letter ) ;
        }
        else {
            // if not windows - great, it'll work.
            // if windows but we don't have MB - shit happens
