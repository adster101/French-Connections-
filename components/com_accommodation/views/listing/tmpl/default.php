  ...
  <div class="row-fluid">
    ...
    <div class="span4">
      ...
      <?php if ($this->item->booking_form) : ?>
        <?php JHtml::_('bootstrap.modal', 'modal') // Outputs the javascript for a joomla bootstrap modal (i.e. one in an iframe) ?>    
        <?php echo JText::_('COM_ACCOMMODATION_BOOKING_FORM_VIEW'); ?>
      <?php endif; ?>
