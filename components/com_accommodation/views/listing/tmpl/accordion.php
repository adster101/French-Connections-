    ...
    <div class="col-xs-12">
      <div class="property-buttons-row clearfix">
        <?php if (!empty($search_url)) : ?>
          <a class="btn btn-warning btn-sm" href="<?php echo $search_url ?>" title="">    
            <span class="glyphicon glyphicon-circle-arrow-left"></span>
            <?php echo JText::_('COM_ACCOMMODATION_BACK_TO_SEARCH_RESULTS'); ?>
          </a>
        <?php else: ?>
          <a class="btn btn-warning btn-sm" href="<?php echo $search_route ?>" title="">    
            <span class="glyphicon glyphicon-circle-arrow-left"></span>
    ...
    <div class="col-lg-4 col-lg-push-8 col-md-4 col-md-push-8 col-sm-5 col-sm-push-7 col-xs-12 key-facts">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <?php endif; ?>
          <p>
            <a class="btn btn-primary btn-block" id="enquiry" href="<?php echo JRoute::_('index.php?option=com_accommodation&Itemid=' . $Itemid . '&id=' . (int) $this->item->property_id . '&unit_id=' . (int) $this->item->unit_id . $append); ?>#email">
              <?php echo ($this->item->is_bookable) ? JText::_('COM_ACCOMMODATION_SITE_BOOK_NOW') : JText::_('COM_ACCOMMODATION_SITE_CONTACT_OWNER'); ?>  
            </a>
          </p>
          <p>
            <a class="btn btn-danger btn-block" href="<?php echo JRoute::_('index.php?option=com_accommodation&Itemid=' . $Itemid . '&id=' . (int) $this->item->property_id . '&unit_id=' . (int) $this->item->unit_id . $append); ?>#availability">
              ...
              <div class="panel-body">
                ...
                <?php if (!empty($this->item->getting_there)) : ?>
                  ...
                  <?php if (array_key_exists('Location access', $this->property_facilities)) : ?>
                    <h4>
                      <?php echo JText::_('COM_ACCOMMODATION_SITE_ACCESS_OPTIONS') ?>
                    </h4>
                    <p><?php echo implode(', ', $this->property_facilities['Location access']) ?></p>         
                  <?php endif; ?>
                  <h4>
                    <?php echo JText::_('COM_ACCOMMODATION_NEAREST_AIRPORT') ?>
                  </h4>
                  <p>
