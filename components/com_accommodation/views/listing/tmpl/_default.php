...
<div class="container">
  <?php if (count($this->offer)) : ?>
    <div class="well well-small special-offer">
      ...
      <p>
        <?php echo JText::sprintf('COM_ACCOMMODATION_OFFER_ENDS', $this->offer->days, $this->route . '#email'); ?>
      </p>
    </div>
  <?php endif; ?>
  ...
  <div class="row" id="main">
    ...
    <div class="col-lg-5 col-md-5 col-sm-12 key-facts">
      <div class="well well-light-blue">
        ...
        <p class="center">
          <a class="btn btn-info btn-lg" href="<?php echo JRoute::_('index.php?option=com_accommodation&Itemid=' . $Itemid . '&id=' . (int) $this->item->property_id . '&unit_id=' . (int) $this->item->unit_id ); ?>#availability">
            <?php echo JText::_('COM_ACCOMMODATION_SITE_CHECK_AVAILABILITY'); ?>  
          </a>
          <a class="btn btn-primary btn-lg"  id="enquiry" href="<?php echo JRoute::_('index.php?option=com_accommodation&Itemid=' . $Itemid . '&id=' . (int) $this->item->property_id . '&unit_id=' . (int) $this->item->unit_id ); ?>#email">
