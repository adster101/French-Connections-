...
class RSFormProValidations
{
	...
	function EmailNotRegistered($email,$extra=null,$data=null)
	{
		// First check that a valid email address has been supplied
		if(!RSFormProValidations::email($email,null))
			return false;
		// If so check that it doesn't exist in the relevant table.
