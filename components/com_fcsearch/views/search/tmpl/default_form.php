  ...
  <div class="row-fluid">
    <div class="well well-small clearfix">
      ...
      <div class="span2">
        ...
        <input type="text" name="start_date" id="start_date" size="30" value="" class="start_date span9" autocomplete="Off" />
      </div>
      <div class="span2">
        <label for="end_date">
          <?php echo JText::_('COM_FCSEARCH_SEARCH_DEPARTURE') ?>
        </label>   
        <input type="text" name="q" id="end_Date" size="30" value="" class="end_date span9" autocomplete="Off"/>
      </div>    
      <div class="span2">
