	...
	<div class="container component">
		<div class="row">
			...
			<?php if ($this->countModules('left') && $this->countModules('right')) { ?>
				<div class="seven columns push-three">
			<?php } else { ?>
			...
			<?php } ?>
				...
				<?php 
					// If not the homepage and module is published to breadcrumbs
					if ($menu->getActive() !== $menu->getDefault() && $this->countModules('bread-crumbs')) { ?>
						<jdoc:include type="modules" name="bread-crumbs" style="xhtml" />	
				<?php } ?>
