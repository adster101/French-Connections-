...
<div class="item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Article">
    ...
    <?php if ($params->get('show_title') || $params->get('show_author')) : ?>
        <div class="jumbotron item-page<?php echo $this->pageclass_sfx; ?>" style="background: url('<?php echo htmlspecialchars($images->image_fulltext); ?>') no-repeat center;background-size:cover;">
          <div class="deep-blue-bg padding-lg strapline">
            <h1>
