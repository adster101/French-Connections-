...
<div class="panel-home-page-search-container" style="position:relative">
  <div class="panel panel-home-page-search">  
    <div class="panel-body">
      ...
      <form id="property-search" action="<?php echo JRoute::_('index.php?option=com_fcsearch&lang=' . $lang . '&Itemid=' . (int) $Itemid . '&s_kwds=' . JText::_('COM_FCSEARCH_S_KWDS_DEFAULT')) ?>" method="POST" class="form-inline">
        ...
        <input id="s_kwds" class="typeahead search-box form-control col-lg-12 col-md-12 col-sm-12 col-xs-12" type="text" name="s_kwds" autocomplete="Off" 
          ...
          <input type="text" name="arrival" id="arrival" size="30" value="<?php echo $arrival ?>" 
                 class="start_date col-sm-4 col-xs-4 form-control" autocomplete="Off" placeholder="<?php echo JText::_('COM_FCSEARCH_ACCOMMODATION_ARRIVAL_DATE') ?>" />
          ...
          <input type="text" name="departure" id="departure" size="30" value="<?php echo $departure ?>" 
                 class="end_date col-sm-4 col-xs-4" autocomplete="off" placeholder="<?php echo JText::_('COM_FCSEARCH_ACCOMMODATION_DEPARTURE_DATE') ?>" />
