...
<div id="askus">
        ...
        <div class='row'>
            <div class='col-lg-6 col-lg-offset-3'>
                <form id="contact-form" action="<?php echo JRoute::_('/contact-us?competition=true&name=wintickets'); ?>" method="post" class="">
                    <fieldset class="adminform">
                        ...
                        <div class="form-group">
                          ...
                          <label>
                            I've read and agree to the <a href="/win-two-tickets-to-the-france-show/competition-terms-conditions" target="_blank">Terms and Conditions</a> for the prize draw
