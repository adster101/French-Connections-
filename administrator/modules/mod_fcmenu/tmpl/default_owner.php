...
if ($manage_account)
{
  ...
  $menu->addChild(new JMenuNode(JText::_('TPL_ISIS_EDIT_ACCOUNT'), 'index.php?option=com_admin&task=profile.edit&id=' . (int) $user->id . '#tab-general', 'class:accounts'));
  $menu->addChild(new JMenuNode(JText::_('TPL_ISIS_EDIT_ACCOUNT_SMS'), 'index.php?option=com_admin&task=profile.edit&id=' . (int) $user->id . '#tab-sms', 'class:accounts'));
