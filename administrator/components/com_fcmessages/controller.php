...
class FcMessagesController extends JControllerLegacy
{
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		// Check for edit form.
		if ($view == 'message' && $layout == 'edit' && !$this->checkEditId('com_fcmessages.edit.message', $id))
		{
			// Somehow the person just went to the form - we don't allow that.
			$this->setError(JText::sprintf('JLIB_APPLICATION_ERROR_UNHELD_ID', $id));
			$this->setMessage($this->getError(), 'error');
			$this->setRedirect(JRoute::_('index.php?option=com_fcmessages&view=messages', false));
