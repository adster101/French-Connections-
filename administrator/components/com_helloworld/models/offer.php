 ...
 * HelloWorld Model
 */
class HelloWorldModelOffer extends JModelAdmin
{
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Offer', $prefix = 'HelloWorldTable', $config = array()) 
	{
	...
	{	
		...
		// Get the form.
		$form = $this->loadForm('com_helloworld.helloworld', 'offer', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
