 ...
 * HelloWorld Model
 */
class HelloWorldModelSetUpAutoRenewal extends JModelAdmin
{
  ...
  public $extension = 'com_helloworld';
	...
	{	
		...
		// Get the form.
		$form = $this->loadForm('com_helloworld.helloworld', 'setupautorenewal', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
