...
class JHtmlProperty {
    ...
    public static function progressButton($listing_id = '', $unit_id = '', $controller = '', $action = 'edit', $icon = '', $button_text = '', $item = '', $urlParam = 'property_id', $btnClass = '', $current_view = '') {
        ...
        $id = ($urlParam == 'unit_id') ? $unit_id : $listing_id;
    ...
    public static function progressMultiTabs($data, $task, $view) {

        $html = '';
        $active = ($task == $view) ? 'active' : '';


        $html.='<li class="dropdown "' . $avtive . '">'
                . '<a class="dropdown-toggle"'
                . 'data-toggle="dropdown"'
                . 'href="#">'
                . '<i class="icon icon-home"></i>';
        $html.= JText::_('COM_HELLOWORLD_HELLOWORLD_ACCOMMODATION_DETAILS')
                . '<b class="caret"></b></a>'
        ...
        foreach ($data as $item) {
            ...
            $html.='<li>';
            $html.= JHtmlProperty::progressButton($item->id, $item->unit_id, 'unitversions', 'edit', 'home', $item->unit_title, $units[$value->unit_id], 'unit_id', '');
            $html.='</li>';
        }
        $html.='</ul></li>';
    }
