...
?>
<form action="<?php echo JRoute::_('index.php?option=com_helloworld&view=location&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="helloworld-form" class="form-validate">
