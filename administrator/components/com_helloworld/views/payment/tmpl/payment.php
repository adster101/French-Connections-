...
<div class="row-fluid">
  <?php if (!empty($this->sidebar)): ?>
    ...
    <?php else : ?>
      ...
      <form action="<?php echo JRoute::_('index.php?option=com_helloworld&option=com_helloworld&view=renewal&layout=payment&id=' . (int) $this->id) ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
