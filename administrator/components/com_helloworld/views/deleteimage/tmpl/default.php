<fieldset class="adminform">
  ...
  <hr />
  <a class="btn-danger btn btn-large fltrt" href="<?php echo JRoute::_('index.php?option=com_helloworld&task=images.delete&id=' . (int) $this->id) . '&file=' . (int) $this->file_id . '&' . JSession::getFormToken() . '=1'; ?>">
