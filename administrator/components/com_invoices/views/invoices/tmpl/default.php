...
if ($saveOrder) {
  $saveOrderingUrl = 'index.php?option=com_invoices&task=invoices.saveOrderAjax&tmpl=component';
  JHtml::_('sortablelist.sortable', 'invoiceList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
            ...
            <tr class="row<?php echo $i % 2; ?>">
              ...
              <?php if (isset($this->items[0]->id)): ?>
                ...
                <?php else: ?>
                  Sundries
                <?php endif; ?>
                <a href="<?php echo JRoute::_('index.php?option=com_invoices&view=invoice_lines&invoice_id=' . (int) $item->id) ?>">
