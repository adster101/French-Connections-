...
class InvoicesModelInvoice extends JModelList
{
  ...
  protected function getListQuery()
  {
    ...
    $query->select('i.id,i.user_id,i.due_date,i.property_id,date_format(i.date_created, "%d %M %Y") as date_created,i.total_net,i.vat,i.property_id,i.first_name,i.surname,i.address1,i.address2,i.address3,i.town,i.county,i.postcode');
