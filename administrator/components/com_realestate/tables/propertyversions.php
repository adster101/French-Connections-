 ...
 * Hello Table class
 */
class RealestateTablePropertyVersions extends JTable {
  ...
  function __construct(&$db) {
    parent::__construct('#__realestate_property_versions', 'realestate_property_id', $db);
  }
  ...
  public function load($keys = null, $reset = true, $latest = true) {
    ...
    /*
     * If latest is false then we load the latest published version, if there is one.
     */
    if (!$latest) {
