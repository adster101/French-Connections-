...
class RealestateModelListings extends JModelList
{
    ...
    ');
      ...
      ');
        ...
        // 1 = hide, 2= show
        // Hide snoozed if filter is applied and there is a date filter
        // or if date filter is being applied 
        // or hide snooze is being applied
        ...
        $query->join('inner', '#__realestate_property_versions as b on (
      a.id = b.realestate_property_id
