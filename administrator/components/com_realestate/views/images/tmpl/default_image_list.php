            ...
            <div class="panel panel-default">
                ...
                <div class="lead">
                  ...
                  <div class="pull-right">
                    ...
                    <a class="delete muted" 
                       href="<?php echo '/administrator/index.php?option=com_realestate&task=images.delete&' . JSession::getFormToken() . '=1&id=' . (int) $item->id . '&realestate_property_id=' . (int) $this->items[0]->realestate_property_id ?>"
              ...
              <div class="panel-body">
                ...
                <p>
                  ...
                  <a class="update-caption" 
                     href="<?php echo '/administrator/index.php?option=com_realestate&tmpl=nohead&view=caption&' . JSession::getFormToken() . '=1&id=' . (int) $item->id . '&realestate_property_id=' . (int) $this->items[0]->realestate_property_id ?>" >
