 ...
 */
class RentalModelHelloWorlds extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$extension = $app->getUserStateFromRequest('com_rentals.helloworlds.filter.extension', 'extension', 'com_rentals', 'cmd');
	...
	protected function getListQuery()
	{
		...
		if (!empty($search)) {
			if (stripos($search, 'id:') === 0) {
				...
				// Get an instance of the RentalTable which is a nested set class
