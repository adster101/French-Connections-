 ...
 * HelloWorld Model
 */
class RentalModelUserProfile extends JModelAdmin {
   ...
   * @since	1.6
   */
  public function getTable($type = 'UserProfileFc', $prefix = 'RentalTable', $config = array()) {
  ...
  public function getForm($data = array(), $loadData = true) {
    ...
    // Get the form.
    $form = $this->loadForm('com_rental.helloworld', 'userprofile', array('control' => 'jform', 'load_data' => $loadData));
    if (empty($form)) {
      return false;
    }
