 ...
 * @since       11.1
 */
class JFormFieldProximityOverrideRadio extends JFormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  11.1
	 */
	protected $type = 'ProximityOverrideRadio';
	...
	protected function getInput()
	{
		...
		foreach ($options as $i => $option)
		{
  		...
  		$counter = ((int) $this->element['counter']) ? $this->element['counter'] : '';
			...
			$html[] = '<input type="radio" id="' . $this->id . $i . '" name="' . $this->name . '[' . $counter . ']" value="'
