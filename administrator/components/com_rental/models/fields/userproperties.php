...
class JFormFieldUserProperties extends JFormFieldList
{
    ...
    $userID = $this->element['user'] ? $this->element['user'] : ''; 
      ...
      $table = JTable::getInstance('HelloWorld', 'RentalTable');
      ...
      //<option value="">COM_RENTAL_HELLOWORLD_CREATE_NEW_PROPERTY_PLEASE_CHOOSE</option>
			//<option value="1">COM_RENTAL_HELLOWORLD_CREATE_NEW_PROPERTY_NO_PARENT</option>
      $options[] = JHtml::_('select.option', '', JText::_('COM_RENTAL_HELLOWORLD_CREATE_NEW_PROPERTY_PLEASE_CHOOSE'));
      $options[] = JHtml::_('select.option', '1',JText::_('COM_RENTAL_HELLOWORLD_CREATE_NEW_PROPERTY_NO_PARENT'));
