 ...
 * @since		1.6
 */
class JFormFieldTariffscopy extends JFormFieldGroupedList
{
  ...
  protected function getGroups()
  {
    ...
    $options = array();
    $property_id = $this->element['property_id'];
    ...
    $query->where('b.property_id = ' . (int) $property_id);  // Select only the props created by the user that created this property
    $query->where('a.id <> ' . (int) $unit_id);  // Select only the props created by the user that created this property
