 ...
 * HelloWorld Model
 */
class RentalModelFacilities extends JModelAdmin {
   ...
   * @since	1.6
   */
  public function getTable($type = 'HelloWorld', $prefix = 'RentalTable', $config = array()) {
   ...
   * @since	1.6
   */
  public function getAttributesTable($type = 'PropertyAttributes', $prefix = 'RentalTable', $config = array()) {
    return JTable::getInstance($type, $prefix, $config);
  }
  ...
  public function getForm($data = array(), $loadData = true) {
    // Get the form.
    $form = $this->loadForm('com_rental.facilities', 'facilities', array('control' => 'jform', 'load_data' => $loadData));
    if (empty($form)) {
      return false;
    }
  ...
  protected function loadFormData() {
    ...
    $data = JFactory::getApplication()->getUserState('com_rental.edit.facilities.data', array());
