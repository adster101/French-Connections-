...
$canChangeOwner = $user->authorise('core.edit.state', 'com_rental');
?>
<form action="<?php echo JRoute::_('index.php?option=com_rental&view=helloworld&task=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate ">
  <div class="row-fluid">
    <div class="span10 form-inline">
      <fieldset class="adminform">
        <legend><?php echo JText::_('COM_RENTAL_HELLOWORLD_ACCOMMODATION_DESCRIPTION'); ?></legend>
      ...
      <fieldset class="adminform">
        <legend><?php echo JText::_('COM_RENTAL_HELLOWORLD_OCCUPANCY_DETAILS'); ?></legend>
        <div class="control-group">
