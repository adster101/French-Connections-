...
?>
<form action="<?php echo JRoute::_('index.php?option=com_rental&view=availability&task=edit&id=' . (int) $this->item->id); ?>"
      method="post" name="adminForm" id="adminForm" class="form-validate">
  <div class="row-fluid">
    <div class="span8">
      <fieldset class="adminform">
        <legend><?php echo JText::_('COM_RENTAL_HELLOWORLD_TARIFFS'); ?></legend>
        <p>
          <a href="#" class="fltrt">
            <span class="icon-16-info hasTip"
                  title="<?php echo JText::_('COM_RENTAL_HELLOWORLD_TARIFFS_HELP'); ?>"></span>
          </a>
        </p>
        <p class="clear"><?php echo JText::_('COM_RENTAL_HELLOWORLD_TARIFFS_INSTRUCTIONS'); ?></p>
        <?php foreach ($tariff_field_sets as $fieldset) { ?>
          <fieldset class="adminform">
            <legend><?php echo JText::_('COM_RENTAL_HELLOWORLD_TARIFF'); ?></legend>
    ...
    <div class="span4">
      <fieldset class="adminform">
        <legend><?php echo JText::_('COM_RENTAL_HELLOWORLD_ADDITIONAL_TARIFFS_DETAIL'); ?></legend>
        <?php
