          ...
          <tr>
            ...
            <th width="12%">
              <?php if ($canDo->get('helloworld.sort-by-expiry')) : ?>
                <?php echo JHtml::_('grid.sort', 'COM_RENTAL_HELLOWORLD_HEADING_DATE_EXPIRY', 'expiry_date', $listDirn, $listOrder); ?>
              <?php else: ?>
            ...
            <?php endif; ?>
            <th width="3%">
              <?php echo JText::_('COM_RENTAL_HELLOWORLD_HEADING_PUBLISHED'); ?>
            </th>	
            <th>              
            ...
            <?php if ($canEditOwn) : ?>
              <tr class="row<?php echo $i % 2; ?>">
                ...
                <td>
                  ...
                  <?php endif; ?>
                  <a href="<?php echo JRoute::_('index.php?option=com_rental&task=helloworld.edit&id=' . (int) $item->id) . '&' . JSession::getFormToken() . '=1'; ?>">
                ...
                <td>                  
                  ...
                  <?php if ( $days_to_renewal > 0 && $item->parent_id == 1 && $days_to_renewal < 28) : ?>
                    <br /><span><?php echo JText::sprintf('COM_RENTAL_HELLOWORLD_DAYS_TO_RENEWAL',$days_to_renewal); ?></span>
                  <?php elseif ($item->parent_id == 1 ) : ?>
                    <a class="btn btn-danger btn-small">
                      <?php echo JText::_('COM_RENTAL_HELLOWORLD_RENEW_NOW'); ?>
                    </a>
