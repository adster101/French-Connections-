 ...
 * HelloWorlds View
 */
class RentalViewHelloWorlds extends JViewLegacy {
  ...
  function display($tpl = null) {
    ...
    JApplication::setUserState("com_rentals_property_count_$userID", count($items));
  ...
  protected function addToolBar() {
    ...
    $document->addStyleDeclaration('.icon-48-helloworld {background-image: url(../media/com_rental/images/fc-logo-48x48.png);}');
    ...
    if ($canDo->get('core.create')) {
      JToolBarHelper::addNew('helloworld.addnew', 'COM_RENTAL_HELLOWORLD_ADD_NEW_PROPERTY', false);
    }
    ...
    $PFR['value'] = -3;
    $PFR['text'] = 'COM_RENTAL_HELLOWORLD_FOR_REVIEW';
    $PFR['disable'] = '';
    ...
    if ($canDo->get('helloworld.ownermenu.view')) {
      ...
      JHtmlSidebar::addEntry(JText::_('COM_RENTAL_SUBMENU_SMS_NOTIFICATIONS'), 'index.php?option=com_admin&view=profile&layout=edit&id=' . $user->id . '#sms', ($view == 'profile'));
      JHtmlSidebar::addEntry(JText::_('COM_RENTAL_SUBMENU_RENTAL_ACCOMMODATION'), 'index.php?option=com_rental', ($view == 'helloworlds'));
      JHtmlSidebar::addEntry(JText::_('COM_RENTAL_SUBMENU_REALESTATE_ACCOMMODATION'), 'index.php?option=com_realestate', ($view == 'realestate'));
