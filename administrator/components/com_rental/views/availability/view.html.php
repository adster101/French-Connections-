...
class RentalViewAvailability extends JViewLegacy
{
  ...
  public function display($tpl = null)
  {
    ...
    $this->calendar = RentalHelper::getOwnerAvailabilityCalendar($months = 23, $availability = $this->availability_array);
  ...
  protected function addToolBar()
  {
    ...
    //$bar->appendButton('Standard', 'apply', 'JTOOLBAR_APPLY', 'availability.cancel', false);
    $bar->appendButton('Standard', 'save', 'JTOOLBAR_SAVE', 'availability.cancel', false);
