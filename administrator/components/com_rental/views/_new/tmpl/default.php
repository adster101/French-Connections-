...
if ($this->items > 0) :
  ?>
  <form method="post" name="adminForm" id="adminForm" class="form-validate" action="<?php echo JRoute::_('index.php?option=com_rental&task=helloworld.addnew') . '&' . JSession::getFormToken() . '=1'; ?>">

    <div class="pre_message">
      <?php echo JText::_('COM_RENTAL_HELLOWORLD_SECOND_NEW_PROPERTY_BLURB'); ?>
    </div>
    <fieldset class="adminform">
      <h4><?php echo JText::_('COM_RENTAL_HELLOWORLD_SECOND_NEW_PROPERTY_LEGEND'); ?></h4>
