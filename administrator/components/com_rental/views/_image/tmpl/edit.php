...
<?php if (!empty($this->sidebar)): ?>
  ...
  <?php else : ?>
    ...
    <?php endif; ?>
      ...
      <form class="form-validate" id="fileupload" action="<?php echo JRoute::_('index.php?option=com_rental&task=images.upload&' . JSession::getFormToken() . '=1'); ?>" method="GET" enctype="multipart/form-data">
