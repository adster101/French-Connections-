...
$open = true;
?>
<form action="<?php echo JRoute::_('index.php?option=com_rental&view=facilities&task=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate ">
  <fieldset>
    <legend><?php echo JText::_('COM_RENTAL_FACILITIES_LEGEND'); ?></legend>
    <p><?php echo JText::_('COM_RENTAL_FACILITIES_BLURB'); ?></p>
