  ...
  protected function addToolBar() {
    ...
    if ($canDo->get('core.edit.state')) {
      ...
      JHtmlSidebar::addFilter(
        ...
        'filter_published',
        JHtml::_('select.options', EnquiriesHelper::getStateOptions(), 'value', 'text', $this->state->get('filter.published'), true)
      );	 
      
      $this->sidebar = JHtmlSidebar::render();

      JToolBarHelper::publish('enquiries.publish', 'COM_EQNUIRIES_MARK_AS_READ', true);
