...
class BeauxVillages extends RealestateImport {
    ...
    public function doExecute() {
        ...
        $db = JFactory::getDbo();
        $user = JFactory::getUser('julie.savill@beauxvillages.com')->id;
...
JApplicationCli::getInstance('BeauxVillages')->execute();
